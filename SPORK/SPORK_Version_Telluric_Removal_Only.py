...
telRem1 = remove_tellurics_p(algn1.copy())
telRem2 = remove_tellurics_p(algn2.copy())
...
for ik in range(nkp):
  ...
  for iv in range(nvrest):
      ...
      telRemInj1 = mask_data(masking(1,remove_tellurics_p(algnInj1)))
      telRemInj2 = mask_data(masking(2,remove_tellurics_p(algnInj2)))
